...
BEGIN
        ...
        IF plan_id_var IS NOT NULL AND week_day_m IS NOT NULL AND mealtime_m IS NOT NULL THEN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `trainer_create_health_report` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `trainer_create_health_report`(IN age_p INT, IN weight_p FLOAT, IN height_p FLOAT, IN fat_percentage_p FLOAT, IN smoking_p BOOL, 
...
-- Dump completed on 2023-04-13 16:47:47
